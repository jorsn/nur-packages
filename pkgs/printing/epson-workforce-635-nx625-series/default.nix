{
  autoconf, automake, cups, gzip, libjpeg, libtool, rpmextract,
  fetchurl, lib, stdenv
}:
...
in stdenv.mkDerivation rec {
  ...
  src = builtins.fetchurl {
    url = "http://a1227.g.akamai.net/f/1227/40484/7d/download.ebz.epson.net/dsc/f/01/00/01/68/57/8935b6eece214505342a868e8b1614e367da1394/${name}-${version}-1lsb3.2.src.rpm";
    sha256 = "c2fdb47e0a1bf0f0a4ed3ad689fe96335d853572c208795e367be7e40114cba6";
  };
  sourceRoot = srcdirs.filter;

  buildInputs = [ autoconf automake cups gzip libjpeg libtool rpmextract ];
  ...
  installPhase =
    let
      ...
      libdir =
        ...
        else throw "TODO: other platforms than i686_linux and x86_64-linux";
    in ''
  ...
  meta = {
    ...
    '';
    downloadPage = http://download.ebz.epson.net/dsc/du/02/DriverDownloadInfo.do?LG2=EN&CN2=&DSCMI=16857&DSCCHK=4334d3487503d7f916ccf5d58071b05b7687294f;
